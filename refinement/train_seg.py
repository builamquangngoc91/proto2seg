...
def main(args):
    ...
    if args.gpus > 1 and args.local_rank != -1:
        ...
        args.local_rank = 0  # Set to 0 for single GPU

    # Only create logger on main process (rank 0)
    ...
    # Create device - use local_rank only if distributed, otherwise use 0
    if args.distributed:
